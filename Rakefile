...
PROJECT_SCHEME = 'CheckboxLink' #
PROJECT_NAME = 'CheckboxLink.xcodeproj'
WORKSPACE_NAME = 'CheckboxLink.xcworkspace'
CONFIGURATION = 'Release' # The build configuration to use
INFOPLIST_PATH = 'CheckboxLink/CheckboxLink-Info.plist'
IPA_FILE_NAME = 'CheckboxLink.ipa'
RESIGNED_IPA_FILE_NAME = 'CheckboxLink.resigned.ipa'
DSYM_FILE_NAME = 'CheckboxLink.app.dSYM.zip'
